...
dat2           <- i2d(image="../example_figure/p_c2.png",  p.n=1000);
...
rgl.postscript("do_3d_C2_3.pdf","pdf");
rgl.postscript("do_3d_C2_4.pdf","pdf");

dir.create("do_3d_C2_d")
for (i in 1:90) {
  view3d(userMatrix=rotationMatrix(2*pi * i/90, 1, -1, -1))
  rgl.snapshot(filename=paste("do_3d_C2_d/frame-",
                              sprintf("%03d", i), ".png", sep=""))
}

system("convert -delay 5 -loop 0 do_3d_C2_d/frame*.png do_3d_C2.gif");
